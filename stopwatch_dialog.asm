...
.loop:          inc     [second]
                ...
                mov     [minute],0
                inc     [hour]
.skip:          invoke  wsprintf,time_text,'%02i:%02i:%02i',[hour],[minute],[second]
...
proc DialogProc hwnddlg,msg,wparam,lparam
                ...
                xor     eax,eax
                jmp     .finish
.wmcommand:     cmp     [wparam],BN_CLICKED shl 16 + ID_START
                je      .f_start
                cmp     [wparam],BN_CLICKED shl 16 + ID_STOP
                je      .f_stop
                jmp     .exit
.f_start:       invoke  TerminateThread,[threadHandle],0
                invoke  CreateThread,0,0,ThreadProc,0,0,threadID
                mov     [threadHandle],eax
                jmp     .exit
.f_stop:        invoke  TerminateThread,[threadHandle],0
                jmp     .exit
